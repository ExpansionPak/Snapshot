...
std::vector<recomp::GameEntry> supported_games = {
    {
        .rom_hash = 0x73CBBC5C7DE9425CULL,
        .internal_name = "POKEMON SNAP",
        .game_id = u8"snap.n64.us.1.0",
        .mod_game_id = "snap",
        .save_type = recomp::SaveType::Flashram, // Snap uses 1Mbit FlashRAM (512k/1Mbit)
        .is_enabled = true,
